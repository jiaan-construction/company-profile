...
We put MOM-registered tower crane operators on your site and keep them there.
...
| Institutional & conservation | Jurong Pioneer Junior College, Golden Mile Complex |

Full project list: [Track-Record.md](./Track-Record.md)

## How we run a site

**Shift cover that holds.** Day, night, or 24-hour rotation. We currently run night shift and round-the-clock rotations on several projects — that is not a one-off arrangement we're describing, it's the normal operating pattern for part of our crew.

**Same-day replacement.** Operators get sick, take leave, go home on emergency. We keep relief operators who already know the machines and hold the right certificates, so the crane doesn't stand idle waiting for a name to be cleared.
...
| | |
|---|---|
| Registered name | JIA AN CONSTRUCTION PTE. LTD. |
| UEN | 202204260G |
| Entity type | Exempt Private Company Limited by Shares |
| Incorporated | 8 February 2022 |
| Principal activity | General Contractors — Building Construction incl. Major Upgrading Works (SSIC 41001) |
| Secondary activity | Other Specialised Construction Activities N.E.C. (SSIC 43909) |
| Registered office | 1 North Bridge Road, #06-17 High Street Centre, Singapore 179094 |
| Banker | Maybank Singapore Limited — Clementi Branch (SWIFT MBBESGS2) |
...
If you have cranes going up and no crew lined up, call. We'll tell you straight whether we can cover it.
